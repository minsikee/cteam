...
public class Sub1 extends AppCompatActivity {
    ...
    // 이미 화면이 있을때 받는곳
    @Override
    protected void onNewIntent(Intent intent) {     //갱신이 안되서 ->oncreate 안가고 기존에 있는 화면을 쓴다. 화면 재사용
    ...
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) { //데이터 받을때
